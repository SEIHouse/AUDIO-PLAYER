 ...
 */
export declare function PlayerHero({ face, collapsed, title, artist, art, className, album, featuredArtists, versionLabel, explicit, releaseTitle, subtitle, marquee, }: PlayerHeroProps): import("react").JSX.Element;
