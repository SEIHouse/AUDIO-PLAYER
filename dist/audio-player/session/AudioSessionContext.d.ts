 ...
 */
export declare function AudioSessionProvider({ children, initialQueue, initialIndex, autoPlay, repeatMode: initialRepeat, shuffle: initialShuffle, automix: initialAutomix, plugins: externalPlugins, audioBackend, onFallbackSource, }: AudioSessionProviderProps): import("react").JSX.Element;
